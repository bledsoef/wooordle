    ...
    return (
        <div className="flex flex-col items-center justify-between h-full text-white">
            ...
            <ul className="space-y-2 mb-8 text-4xl text-wrap p-2">
                ...
                <li className="flex text-xl">A <p className="text-yellow-450 mx-1">YELLOW</p> letter indicates it is in the word but not the correct position.</li>
                <li className="flex text-xl">If your previous guess is UNDERLINED that means the amount of letters in that guess was CORRECT.</li>
            </ul>
